...
<body>
    <section class="register-container">
        ...
        <form class="form-container" method="POST" action="{{ route('login') }}">
            ...
            @enderror
            <input type="password" placeholder="Contraseña" id="password" name="password" required autocomplete="current-password">
            @error('password')
                <span class="error">
                    <strong>{{ $message }}</strong>
                </span>
            @enderror
            <p>¿Has olvidado tu cuenta? <a href="{{ route('password.request') }}">restablecer contraseña</a></p>
